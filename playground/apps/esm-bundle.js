...
const PlaygroundApp = Vue.extend({
  ...
  data: () => ({
    ...
    facebookContent: defaultFacebookEmbedContent,
    twitterContent: defaultTwitterEmbedContent,
    instagramContent: defaultInstagramEmbedContent,
    youtubeContent: defaultYoutubeEmbedContent,
  }),
  template: `
    <div>
